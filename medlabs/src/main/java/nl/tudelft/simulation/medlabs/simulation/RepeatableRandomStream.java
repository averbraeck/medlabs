 ...
 * This software is licensed without restrictions to Nederlandse Organisatie
 * voor Toegepast Natuurwetenschappelijk Onderzoek TNO (TNO), Erasmus University
 * Rotterdam, Delft University of Technology, Panteia B.V., Stichting Projecten
 * Binnenvaart, Ab Ovo Nederland B.V., Modality Software Solutions B.V., and
 * Rijkswaterstaat - Dienst Water, Verkeer en Leefomgeving, including the right
 * to sub-license sources and derived products to third parties. <br />
 * 
...
public class RepeatableRandomStream extends Java2Random {
	...
	/**
	 * Return a random stream that is the same every time for a certain name, but
	 * can be changed based on a number (e.g. a year)
	 * 
	 * @param identifier
	 * @param seed
	 * @return a random stream that is the same every time for a certain name and
	 *         integer
	 */
