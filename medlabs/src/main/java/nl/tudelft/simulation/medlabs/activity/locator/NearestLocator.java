...
/**
 * The NearestLocator returns the closest location of a certain type relative to
...
public class NearestLocator implements LocatorInterface {
	...
	/**
	 * @param startLocator         LocationInterface&lt;T&gt; the stating position
	...
	public Location getLocation(final Person person) {
		...
		if (this.activityLocationType.getLocationTypeId() == person.getModel().getLocationTypeHouse()
				.getLocationTypeId()) {
