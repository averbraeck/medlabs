...
/**
 * The CarLocator returns the generic car location for a person, which is a large space in which no infections occur.
 * <p>
 ...
 */
public class CarLocator implements LocatorInterface
{
    /** {@inheritDoc} */
    @Override
    public Location getLocation(final Person person)
    {
        return person.getModel().getLocationCar();
    }
