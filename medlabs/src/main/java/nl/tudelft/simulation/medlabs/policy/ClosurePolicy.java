...
/**
 * Policy class for the medlabs models. The ClosurePolicy deals with shutting
 * down certain location, and possibly with adapting the activity schedules of
 * persons. The activity schedule changes are induced at midnight of every day
 * by persons checking the policy.
 * <p>
...
public class ClosurePolicy extends Policy {
	 ...
	 */
	public ClosurePolicy(final MedlabsModelInterface model, final String name,
