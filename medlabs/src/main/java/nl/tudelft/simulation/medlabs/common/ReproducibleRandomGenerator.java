...
/**
 * The ReproducibleRandomGenerator class implements a RNG implementation where
 * we can <b>reproduce</b> a random draw based on a value that we provide, such
 * as a personId. Still, between replications or runs with a different seed for
 * the RNG, the draws for that same person would be different, yet reproducible.
 * <p>
...
public class ReproducibleRandomGenerator extends MersenneTwister implements StreamInterface {
	...
	/**
	 * creates a new ReproducibleRandomGenerator and in initializes with a given
	 * seed.
	 * 
	...
	/**
	 * Method returns (pseudo)random number from the stream over the integers i and
	 * j .
	 * 
	 * @param i                 int; the minimal value
	 * @param j                 int; the maximum value
	 * @param reproducibleValue long; the value to use to make the result
	 *                          reproducible
	 ...
	 * one int value is pseudorandomly generated and returned. All 2<sup>32</sup>
	 ...
	 * one long value is pseudorandomly generated and returned.
	 * 
	 * @param reproducibleValue long; the value to use to make the result
	 *                          reproducible
	 ...
	 * @param reproducibleValue long; the value to use to make the result
	 *                          reproducible
	 * @return the next pseudorandom, uniformly distributed float value between 0.0
	 *         and 1.0 from this random number generator's sequence
	 */
	 ...
	 * @param reproducibleValue long; the value to use to make the result
	 *                          reproducible
	 * @return the next pseudorandom, uniformly distributed double value between 0.0
	 *         and 1.0 from this random number generator's sequence
	 */
