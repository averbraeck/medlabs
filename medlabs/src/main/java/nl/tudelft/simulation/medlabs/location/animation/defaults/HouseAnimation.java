...
public class HouseAnimation extends LocationAnimationSquare {
	...
	/** default template. */
	public static final LocationAnimationTemplate HOUSE_TEMPLATE = new LocationAnimationTemplate("University")
			.setLineColor(Color.LIGHT_GRAY).setFillColor(null).setCharacter("").setHalfShortSize(3)
			.setNumberColor(Color.LIGHT_GRAY).setNumberSize(6);
