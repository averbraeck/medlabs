...
public class CollegeAnimation extends LocationAnimationSquare
{
    ...
    /** default template. */
    public static final LocationAnimationTemplate COLLEGE_TEMPLATE =
            new LocationAnimationTemplate("College").setLineColor(Color.MAGENTA).setFillColor(null).setCharacter("C")
                    .setCharacterColor(Color.MAGENTA).setCharacterSize(30).setHalfShortSize(15).setNumberColor(Color.MAGENTA);
