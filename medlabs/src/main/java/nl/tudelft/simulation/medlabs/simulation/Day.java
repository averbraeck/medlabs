...
/**
 * Day prints the day of the week and has methods isWeekday() and isWeekend().
 * This class can be adapted for countries where the weekend does not fall on a
 * Saturday and Sunday with a setter method that indicates the day names,
 * abbreviations, and weekend days as flexible arguments. It can also be used to
 * start the week e.g. on a Sunday. In line with the Global class, this class is
 * static, which means that if two simulations run in one JVM, the need to have
 * the same week composition.
 * <p>
...
public class Day {
	...
	private static String[] names = new String[] { "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday",
			"Sunday" };
	 ...
	 */
	public static void setWeekComposition(final String[] newAbbreviations, final String[] newNames,
			final byte newWeekendDay1, final byte newWeekendDay2) {
