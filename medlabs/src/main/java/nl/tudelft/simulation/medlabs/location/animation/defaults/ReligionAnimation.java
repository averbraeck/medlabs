...
public class ReligionAnimation extends LocationAnimationCross {
	...
	/** default template. */
	public static final LocationAnimationTemplate RELIGION_TEMPLATE = new LocationAnimationTemplate("Religion")
			.setHalfShortSize(6).setLineColor(Color.BLACK).setFillColor(Color.CYAN).setCharacter("")
			.setNumberColor(Color.CYAN);
