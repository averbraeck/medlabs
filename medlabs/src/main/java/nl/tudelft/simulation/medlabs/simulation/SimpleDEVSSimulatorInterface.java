...
/**
 * SimpleDEVSSimulatorInterface is a simulator that accepts double time for
 * relative and absolute simulation events. The time is given in hours, to make
 * scheduling during the day as natural as possible.
 * <p>
...
public interface SimpleDEVSSimulatorInterface extends DevsSimulatorInterface<Double> {
	 ...
	 * @param target Object; the target object on which the method execution is
	 *               scheduled
	 * @param method String; the name of the method to execute within the target
	 *               object
	...
	/**
	 * Initialize a simulation engine without animation; the easy way. PauseOnError
	 * is set to true;
	 * 
	 ...
	 * @throws NamingException     when the context for the replication cannot be
	 *                             created
	 */
	...
	/**
	 * Initialize a simulation engine without animation and prescribed replication
	 * number; the easy way. PauseOnError is set to true;
	 * 
	 * @param startTime     double; the start time of the simulation in hours
	 * @param warmupPeriod  double; the warm up period of the simulation in hours
	 * @param runLength     double; the duration of the simulation in hours
	 ...
	 */
	void initialize(double startTime, double warmupPeriod, double runLength, SimpleModelInterface model,
			int replicationNr, long seed) throws SimRuntimeException, NamingException;
	 ...
	 * 
	 * @return double; the simulator time in hours since the start of the
	 *         simulation.
	 */
	@Override
