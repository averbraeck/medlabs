...
public class ParkAnimation extends LocationAnimationSquare
{
    ...
    /** default template. */
    public static final LocationAnimationTemplate PARK_TEMPLATE =
            new LocationAnimationTemplate("Park").setLineColor(Color.GREEN).setFillColor(null).setCharacter("P")
                    .setCharacterColor(Color.GREEN).setCharacterSize(30).setHalfShortSize(15).setNumberColor(Color.GREEN);
