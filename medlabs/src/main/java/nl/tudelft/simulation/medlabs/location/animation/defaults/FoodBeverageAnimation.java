...
public class FoodBeverageAnimation extends LocationAnimationRect2x1 {
	...
	/** default template. */
	public static final LocationAnimationTemplate FOOD_TEMPLATE = new LocationAnimationTemplate("Food")
			.setLineColor(Color.BLUE).setFillColor(null).setCharacter("F").setCharacterColor(Color.BLUE)
			.setCharacterSize(6).setHalfShortSize(3).setNumberColor(Color.BLUE);
