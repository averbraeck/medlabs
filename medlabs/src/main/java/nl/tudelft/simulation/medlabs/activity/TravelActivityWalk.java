...
/**
 * Travel activity for walking. The activity takes place in a large area where probability for transmission is zero. The "walk"
 * location in which the activity takes place can be used to study the number of people who are outside walking.
 * <p>
...
public class TravelActivityWalk extends TravelActivity
{
     ...
     * @param endLocator
     */
    public TravelActivityWalk(final MedlabsModelInterface model, final String name, final LocatorInterface travelLocator,
