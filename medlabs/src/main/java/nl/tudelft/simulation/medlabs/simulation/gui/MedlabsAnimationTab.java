...
public class MedlabsAnimationTab extends DsolAnimationGisTab {
	...
	/**
	 * Map of visibility layer names (simpleClassName) + "_" + displayName) to
	 * toggle buttons.
	 */
	...
	/**
	 * Construct a tab with an AnimationPane for the animation of a DSOLModel,
	...
	/**
	 * Add a series of buttons for a class for toggling animation based on a String
	 * evaluation.
	 * 
	 * @param nameArray             String[]; the names of the buttons
	 * @param locatableClass        Class&lt;? extends Locatable&gt;; the class for
	 *                              which the button holds (e.g., Person.class)
	 * @param visibilityEvaluator   VisibilityEvaluator&lt;?&gt;; the evaluator
	 * @param toolTipTextArray      String[]; the tool tip texts to show when
	 *                              hovering over the button
	 * @param initiallyVisibleArray boolean[]; whether the classes are initially
	 *                              shown or not
	 * @param <T>                   the locatable type for the animation
	 */
	public <T extends Locatable> void addToggleAnimationStringText(final String[] nameArray,
			final Class<T> locatableClass, final VisibilityEvaluator<T> visibilityEvaluator,
			final String[] toolTipTextArray, final boolean[] initiallyVisibleArray) {
