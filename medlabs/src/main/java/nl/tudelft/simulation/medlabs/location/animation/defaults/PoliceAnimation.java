...
/**
 * Animation of a police location.
 * <p>
 ...
 */
public class PoliceAnimation extends LocationAnimationSquare
{
    /** */
    private static final long serialVersionUID = 20200919L;

    /** default template. */
    public static final LocationAnimationTemplate POLICE_TEMPLATE =
            new LocationAnimationTemplate("Police").setHalfShortSize(10).setLineColor(Color.ORANGE).setFillColor(Color.ORANGE)
                    .setCharacter("P").setCharacterColor(Color.BLACK).setNumberColor(Color.ORANGE);

    /**
     * Create the animation for this location object.
     * @param location the location belonging to this animation
     */
    public PoliceAnimation(final Location location)
    {
        super(location, POLICE_TEMPLATE);
    }
