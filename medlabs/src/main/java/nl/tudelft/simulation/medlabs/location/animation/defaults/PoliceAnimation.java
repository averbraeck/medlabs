...
public class PoliceAnimation extends LocationAnimationSquare {
	...
	/** default template. */
	public static final LocationAnimationTemplate POLICE_TEMPLATE = new LocationAnimationTemplate("Police")
			.setHalfShortSize(10).setLineColor(Color.ORANGE).setFillColor(Color.ORANGE).setCharacter("P")
			.setCharacterColor(Color.BLACK).setNumberColor(Color.ORANGE);
