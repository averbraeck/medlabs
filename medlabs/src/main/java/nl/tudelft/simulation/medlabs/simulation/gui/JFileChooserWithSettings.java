...
/**
 * Small helper class that adds some components to a JFileChooser, the contents
 * of which can be used to retrieve user settings for output. Code based on
...
public class JFileChooserWithSettings extends JFileChooser {
	...
	/**
	 * Constructor that adds components to the left of the 'Save' and 'Cancel'
	 * button.
	 * 
	...
	public JFileChooserWithSettings(final Component... components) {
		...
		// in that left area to the south, a panel for the setting components right to
		// left
