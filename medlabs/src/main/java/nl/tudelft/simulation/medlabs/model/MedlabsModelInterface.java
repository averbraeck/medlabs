...
/**
 * MedlabsModelInterface contains the calls to generic objects that belong to a
 * disease model. Notable examples are:
 * <ul>
 * <li>Simulator</li>
 * <li>Experiment</li>
...
public interface MedlabsModelInterface extends SimpleModelInterface {
	...
	/**
	 * @param interactive boolean; whether the simulation is interactive or a batch
	 *                    run.
	 */
	...
	/**
	 * @return the standard uniform distribution based on the standard random stream
	 *         of the model.
	 */
	DistUniform getU01();
	...
	/**
	 * @return the family compositions in the model (array of person ids), indexed
	 *         by home location.
	 */
	...
	/**
	 * Method to be implemented in the model to check whether the (week) activity
	 * pattern needs to be changed for a person that changed his/her disease phase.
	 * This method is always called at midnight.
	 * 
	 * @param person Person; the person whose disease phase has changed
	 */
	void checkChangeActivityPattern(Person person);

	// /** @return the graph for this network of gridstops and public transport
	// stops. */
	// DefaultDirectedWeightedGraph<Stop, PublicTransportEdge> getDirectedGraph();
	// initialize as: new DefaultDirectedWeightedGraph<Stop,
	// PublicTransportEdge>(PublicTransportEdge.class);
	 ...
	 * 
	 * @param activityMonitor ActivityMonitor; the activity monitor to report
	 ...
	 * 
	 * @param personMonitor PersonMonitor; the person monitor to report changes for
	 *                      statistics
	 */
	 ...
	 * 
	 * @param diseaseTransmission DiseaseTransmission; the disease transmission
	 *                            model.
	 */
	 ...
	 * 
	 * @param diseaseMonitor DiseaseMonitor; the disease monitor to report changes
	 *                       for statistics
	 */
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////
	// Some locations and location types that have to be defined in each model (even
	/////////////////////////////////////////////////////////////////////////////////////////////////// if
	/////////////////////////////////////////////////////////////////////////////////////////////////// not
	/////////////////////////////////////////////////////////////////////////////////////////////////// used)
	...
	// /** @return the location type of the a grid stop in the public transport
	// network. */
