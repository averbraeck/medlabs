...
/**
 * The ContagiousPeriod class is a helper class that stores the stochastic duration for a contagious period.
 * <p>
...
public class DurationDistribution
{
    ...
    /**
     * Create a stochastic contagious period based on a distribution specified in a time unit.
     * @param durationDistribution DistContinuous; the distribution function, specified in the unit
     * @param unit TimeUnit the unit in which the distribution has been specified 
     */
