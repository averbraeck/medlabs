...
public class MedServiceAnimation extends LocationAnimationPlus {
	...
	/** default template. */
	public static final LocationAnimationTemplate MEDSERVICE_TEMPLATE = new LocationAnimationTemplate("MedService")
			.setLineColor(Color.RED).setFillColor(Color.RED).setCharacter("M").setCharacterColor(Color.BLACK)
			.setCharacterSize(12).setHalfShortSize(4).setNumberColor(Color.RED);
