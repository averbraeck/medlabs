 ...
 */
public class UniversityAnimation extends LocationAnimationSquare {
	/** */
	private static final long serialVersionUID = 20200920L;

	/** default template. */
	public static final LocationAnimationTemplate UNIVERSITY_TEMPLATE = new LocationAnimationTemplate("University")
			.setLineColor(Color.MAGENTA).setFillColor(Color.WHITE).setCharacter("U").setCharacterColor(Color.MAGENTA)
			.setCharacterSize(20).setHalfShortSize(10).setNumberColor(Color.MAGENTA);

	/**
	 * @param location
	 */
	public UniversityAnimation(final Location location) {
		super(location, UNIVERSITY_TEMPLATE);
	}
