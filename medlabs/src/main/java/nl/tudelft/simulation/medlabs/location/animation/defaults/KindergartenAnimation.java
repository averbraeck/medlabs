...
public class KindergartenAnimation extends LocationAnimationSquare {
	...
	/** default template. */
	public static final LocationAnimationTemplate KINDERGARTEN_TEMPLATE = new LocationAnimationTemplate("Kindergarten")
			.setLineColor(Color.MAGENTA).setFillColor(null).setCharacter("K").setCharacterColor(Color.MAGENTA)
			.setCharacterSize(16).setHalfShortSize(8).setNumberColor(Color.MAGENTA);
