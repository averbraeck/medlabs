...
/**
 * TinySimEvent is a low-memory footprint implementation of the SimEvent. For
 * now, it delegates to the regular SimEvent, but it can be changed to a smaller
 * version when needed.
 * <p>
...
public class TinySimEvent extends AbstractSimEvent<Double> {
	...
	/**
	 * The constructor of the event stores the time the event must be executed and
	 * the object and method to invoke.
	 * 
