...
public class IdxStudent extends IdxPerson implements Student {
	...
	/**
	 * Create a Student with a number of basic properties, including the school type
	 * and school that the student attends. The init() method has to be called after
	 * the student has been created to make sure the disease state machine is
	 * started for the person if needed. The week pattern starts at day 0 and
	 * activity index 0.
	 * 
	 ...
	 *                         the person will use
	 * @param schoolLocationId int; the location index of the school, relative to
	 *                         the schoolTypeIndex
	 */
