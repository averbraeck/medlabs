 ...
 * Several types of Typed Registers are available in the software (and these can be extended further):
 * <ul>
...
{
    /**
     * Register a person in the registry with the type of registration. A registration type can be an id of, for instance, a
     * vaccine type, test type, or disease type.
     * @param person Person; the person to register in the registry
     * @param type T; the type (e.g., vaccine type, test type, disease type) that needs to be registered for the person
     */
     ...
     * vaccine type, test type, or disease type.
     * @param person Person; the person to register in the registry
     * @param type int; an indication of the type (e.g., vaccine type, test type, disease type) that needs to be registered for
     *            the person
     */
