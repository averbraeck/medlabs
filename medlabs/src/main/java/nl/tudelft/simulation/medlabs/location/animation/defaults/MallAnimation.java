 ...
 */
public class MallAnimation extends LocationAnimationRect2x1 {
	/** */
	private static final long serialVersionUID = 20200919L;

	/** default template. */
	public static final LocationAnimationTemplate MALL_TEMPLATE = new LocationAnimationTemplate("Mall")
			.setLineColor(Color.BLUE).setFillColor(null).setCharacter("M").setCharacterColor(Color.BLUE)
			.setCharacterSize(24).setHalfShortSize(12).setNumberColor(Color.BLUE);
	 ...
	 */
	public MallAnimation(final Location location) {
		super(location, MALL_TEMPLATE);
	}
