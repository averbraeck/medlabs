...
/**
 * A Person is an Agent with a number of characteristics such as age, locations, a disease status, and an activity pattern.
 * <p>
...
public abstract class AbstractPerson extends Agent implements Person
{
     ...
     * to make sure the disease state machine is started for the person if needed.
