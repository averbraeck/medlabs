/**
 * Classes for self tests and centrally administered test for a disease. Persons
 * may change their activity pattern (or not) before and after after receiving a
 * test result.
 * <p>
