...
public class FireStationAnimation extends LocationAnimationSquare {
	...
	/** default template. */
	public static final LocationAnimationTemplate FIRE_TEMPLATE = new LocationAnimationTemplate("Police")
			.setHalfShortSize(10).setLineColor(Color.RED).setFillColor(Color.RED).setCharacter("F")
