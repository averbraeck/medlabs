...
/**
 * Travel activity for biking. The activity takes place in a large area where
 * probability for transmission is zero. The "bike" location in which the
...
public class TravelActivityBike extends TravelActivity {
	...
	/**
	 * Create an Activity type for a single person using the bicycle to get from A
	 * to B.
	 * 
	 ...
	 * @param endLocator
	 */
	public TravelActivityBike(final MedlabsModelInterface model, final String name,
