...
/**
 * Travel activity based on distance. The activity takes place in a large area
 * where probability for transmission is zero. It will either use the "walk",
 * "bike" or "car" location, dependent on distance.
 * <p>
