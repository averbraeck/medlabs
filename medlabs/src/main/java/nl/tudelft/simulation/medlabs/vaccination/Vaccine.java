...
/**
 * The Vaccine class stores information about vaccines in the model. For now,
 * the basic vaccine class does not store extra information -- the vaccine is
 * used in the Disease propagation model. Of course, extensions of the Vaccine
 * class can contain information about the efficacy and duration of
 * effectiveness.
 * <p>
