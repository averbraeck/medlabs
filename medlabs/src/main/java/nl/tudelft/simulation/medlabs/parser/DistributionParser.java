...
/**
 * The DistributionParser utility class can parse a string with a specified
 * distribution, such as Triangular(1, 2, 3) or Uniform(5, 10).
 * <p>
...
public final class DistributionParser {
	...
	/**
	 * Parse a string with a specified continuous distribution, such as
	 * Triangular(1, 2, 3) or Uniform(5, 10).
	 * 
	 * @param distStr String; the textual representation of the distribution
	 * @param stream  StreamInterface; the random stream to use for the instantiated
	 *                distribution
	...
	/**
	 * Parse a string with a specified discrete distribution, such as
	 * Bernoulli(0.25) or .
	 * 
	 * @param distStr String; the textual representation of the distribution
	 * @param stream  StreamInterface; the random stream to use for the instantiated
