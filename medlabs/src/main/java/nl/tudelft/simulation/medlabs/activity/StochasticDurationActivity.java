...
/**
 * The StochasticDurationActivity is an activity for a person where the flexible duration is provided as a distribution
 * function.
 * <p>
...
public class StochasticDurationActivity extends FlexibleDurationActivity
{
     ...
     * @param durationDistribution DistContinuous; the duration distribution in the time unit
     * @param unit TimeUnit; the time unit of the duration distribution
     */
    public StochasticDurationActivity(final MedlabsModelInterface model, final String name, final LocatorInterface locator,
            final double estimatedDuration, final DistContinuous durationDistribution, final TimeUnit unit)
    {
