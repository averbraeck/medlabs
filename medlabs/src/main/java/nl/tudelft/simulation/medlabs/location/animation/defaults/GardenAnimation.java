...
public class GardenAnimation extends LocationAnimationSquare {
	...
	/** default template. */
	public static final LocationAnimationTemplate GARDEN_TEMPLATE = new LocationAnimationTemplate("Garden")
			.setHalfShortSize(8).setLineColor(Color.GREEN).setFillColor(null).setCharacter("G")
			.setCharacterColor(Color.GREEN).setNumberColor(Color.GREEN);
