 ...
 */
public class GardenAnimation extends LocationAnimationSquare
{
    /** */
    private static final long serialVersionUID = 20200920L;

    /** default template. */
    public static final LocationAnimationTemplate GARDEN_TEMPLATE =
            new LocationAnimationTemplate("Garden").setHalfShortSize(8).setLineColor(Color.GREEN).setFillColor(null)
                    .setCharacter("G").setCharacterColor(Color.GREEN).setNumberColor(Color.GREEN);

    /**
     * @param location
     */
    public GardenAnimation(final Location location)
    {
        super(location, GARDEN_TEMPLATE);
    }
