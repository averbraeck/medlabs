...
/**
 * LocationAnimationPlus implements a cross location animation.
 * <p>
 ...
 */
public class LocationAnimationCross extends LocationAnimation
{
    /** */
    private static final long serialVersionUID = 20210102L;

    /**
     * Cross animation for a location. The half short size is the half of the vertical / horizontal plus. The entire symbol is
     * (6*half x 8*half) in size.
     * @param location Location; the location to be animated
     * @param template LocationAnimationTemplate; the template to use
     */
    public LocationAnimationCross(final Location location, final LocationAnimationTemplate template)
    {
    ...
    public void paint(final Graphics2D graphics, final ImageObserver observer)
    {
        ...
        graphics.drawString(number, half + 2, 5 * half);
    }
