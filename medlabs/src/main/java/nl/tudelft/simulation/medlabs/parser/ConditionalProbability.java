...
/**
 * ConditionalProbability contains a probability that is fixed, age-dependent or
 * gender-dependent. It can return the correct probability for a person.
 * <p>
...
public class ConditionalProbability {
	 ...
	 * 
	 * @param probStr String; The string that is either a double between 0 and 1, or
	 *                an age-dependent probability string, or a gender dependent
	 *                probability string
