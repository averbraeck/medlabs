...
public class SupermarketAnimation extends LocationAnimationRect2x1
{
    ...
    /** default template. */
    public static final LocationAnimationTemplate SUPERMARKET_TEMPLATE =
            new LocationAnimationTemplate("Supermarket").setLineColor(Color.BLUE).setFillColor(null).setCharacter("S")
                    .setCharacterColor(Color.BLUE).setCharacterSize(16).setHalfShortSize(8).setNumberColor(Color.BLUE);
