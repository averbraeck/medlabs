...
/**
 * Animation of a supermarket location.
 * <p>
 ...
 */
public class SupermarketAnimation extends LocationAnimationRect2x1 {
	/** */
	private static final long serialVersionUID = 20200919L;

	/** default template. */
	public static final LocationAnimationTemplate SUPERMARKET_TEMPLATE = new LocationAnimationTemplate("Supermarket")
			.setLineColor(Color.BLUE).setFillColor(null).setCharacter("S").setCharacterColor(Color.BLUE)
			.setCharacterSize(16).setHalfShortSize(8).setNumberColor(Color.BLUE);
	 ...
	 */
	public SupermarketAnimation(final Location location) {
		super(location, SUPERMARKET_TEMPLATE);
	}
