...
/**
 * IntegerPropertyArray is a property array for integers.
 * <p>
 ...
 */
public class IntPropertyArray extends PropertyArray<Integer>
{
    /** the array with the int values. */
    private final int[] array;
    
    /**
     * Create a new int property array.
     * @param name String; the name of the property
     * @param size int; the size of the array
     */
    public IntPropertyArray(final String name, final int size)
    {
        super(name, size);
