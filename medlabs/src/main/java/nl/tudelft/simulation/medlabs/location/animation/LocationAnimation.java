...
/**
 * Animation for a generic location. Can be subclassed for specific locations,
 * enabling them to be turned on or off in the AnimationPanel.
 * <p>
...
public abstract class LocationAnimation extends TinyRenderable2D {
	...
	/**
	 * Create a generic animation for a location. Choices for the symbol are:
	 * square, rectangle1x2, rectangle2x1, triangle, circle, plus, cross1x2
	 * 
	 * @param location Location; the location to be animated
	 * @param template LocationAnimationTemplate; the template to use
