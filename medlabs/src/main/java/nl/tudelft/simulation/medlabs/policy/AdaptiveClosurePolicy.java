...
/**
 * Adaptive closure policy class for the medlabs models. An adaptive policy
 * shuts down certain location under a condition.
 * <p>
...
public abstract class AdaptiveClosurePolicy extends ClosurePolicy {
	...
	/**
	 * The monitoring method that is called every night at midnight, and that allows
	 * to check for certain conditions in the model (number of people hospitalized,
	 * number of people in the ICU, etc., and can use the "open" and "close" methods
	 * of the closureLocations of this policy to implement the policy measures.
	 */
