...
public class HistogramDouble extends AbstractHistogram<Double> {
	...
	/**
	 * the number of bins; note that there is always one extra bin for wrong
	 * x-values.
	 */
	 ...
	 */
	public HistogramDouble(final String title, final String xLabel, final String yLabel, final double lo,
			final double hi, final double binSize, final String formatXLabels, final boolean showOther) {
