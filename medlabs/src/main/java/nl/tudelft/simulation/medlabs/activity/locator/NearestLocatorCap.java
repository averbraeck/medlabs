 ...
 */
public class NearestLocatorCap implements LocatorInterface
{
     ...
     */
    public NearestLocatorCap(final LocatorInterface startLocator, final LocationType activityLocationType)
    {
