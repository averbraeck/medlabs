...
/**
 * Set the default animation toggles for the animation tab. Code based on
...
public class AnimationToggles {
	...
	/**
	 * Set the most common animation on, and create the toggles on the left hand
	 * side.
	 * 
	 * @param model MedlabsModelInterface; the model
	 * @param panel MedlabsAnimationPanel; the Animation tab.
	 */
	public static void setTextAnimationTogglesStandard(final MedlabsModelInterface model,
			final DsolAnimationTab panel) {
		...
		for (LocationType type : model.getLocationTypeIndexMap().values()) {
			if (type.getAnimationClass() != null && type.getLocationClass() != null) {
				panel.addToggleAnimationButtonText(type.getName(), type.getLocationClass(),
						"Show/hide " + type.getName(), true);
			}
		}
		panel.addToggleText("  ");
	 ...
	 * @param panel MedlabsAnimationPanel; the Animation tab.
	 */
	public static void setTextAnimationTogglesBasedOnName(final MedlabsModelInterface model,
			final MedlabsAnimationTab panel) {
		panel.addToggleText("INFRASTRUCTURE");
	 ...
	 * @param model          MedlabsModelInterface; the model
	 * @param panel          MedlabsAnimationPanel; the Animation tab.
	 * @param locatableClass Class&lt;? extends Locatable&gt;; the class for which
	 *                       the animation has to be shown.
	 */
