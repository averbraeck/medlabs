...
/**
 * DiseaseState contains a few important states: susceptible, ill, recovered,
 * immune, or dead. Hereby, a rough classification for important decisions by
 * the Person can be made such as removal from the model. The reason for having
 * these states is that the DiseasePhase can be coded by the modeler in any way,
 * using any name, so the important characteristics of the DiseasePhase cannot
 * be determined.
 * <p>
