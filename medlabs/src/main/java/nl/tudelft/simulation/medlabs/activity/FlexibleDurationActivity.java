...
/**
 * The FlexibleDurationActivity is an Activity for a person that takes a
 * flexible amount of time. An example extension of this abstract class is the
 * StochasticDurationActivity where the flexible duration is provided as a
...
public abstract class FlexibleDurationActivity extends AbstractDurationActivity {
	...
	/**
	 * the estimated duration of the activity to take into account for planning
	 * purposes.
	 */
	 ...
	 * the person skip this activity. Create an Activity type.
	 * 
	 ...
	 * @param locator           LocatorInterface&lt;T&gt;; the locator that returns
	 *                          where the activity takes place
	 * @param estimatedDuration double; the estimated duration of the activity (in
	 *                          hours), e.g. for planning purposes
	 */
	public FlexibleDurationActivity(final MedlabsModelInterface model, final String name,
			final LocatorInterface locator, final double estimatedDuration) {
