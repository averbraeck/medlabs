...
/**
 * IntegerPropertyArray is a property array for float values.
 * <p>
 ...
 */
public class FloatPropertyArray extends PropertyArray<Float>
{
    /** the array with the int values. */
    private final float[] array;
    
    /**
     * Create a new float property array.
     * @param name String; the name of the property
     * @param size int; the size of the array
     */
    public FloatPropertyArray(final String name, final int size)
    {
        super(name, size);
    ...
    {
        return (byte) Math.round(this.array[i]);
    }
    ...
    {
        return (short) Math.round(this.array[i]);
    }
