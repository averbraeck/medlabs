...
/**
 * LocationAnimationTemplate contains a template for the animation for a set of
 * locations.
 * <p>
...
public class LocationAnimationTemplate implements Named {
	...
	/**
	 * Half size of the short side of the symbol -- symbol will be two times this
	 * size at least. Note that the half size is NOT the half diameter of the symbol
	 * by default: for a plus, for instance it is the half side of each of the short
	 * sides of the strokes of the plus, making the size of the plus symbol
	...
	/**
	 * Return the half size of the short side of the symbol -- symbol will be two
	 * times this size at least.
	 * 
	...
	/**
	 * Set the half size of the short side of the symbol -- symbol will be two times
	 * this size by default, unless the size of the symbol has already been changed.
	 * The half size is NOT the half diameter of the symbol by default: for a plus,
	 * for instance it is the half side of each of the short sides of the strokes of
	 * the plus, making the size of the plus symbol (6*halfSize x 6*halfSize).
	 * 
