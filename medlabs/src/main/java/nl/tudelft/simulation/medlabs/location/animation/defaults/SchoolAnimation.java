...
public class SchoolAnimation extends LocationAnimationSquare
{
    ...
    /** default template. */
    public static final LocationAnimationTemplate SCHOOL_TEMPLATE =
            new LocationAnimationTemplate("School").setLineColor(Color.MAGENTA).setFillColor(null).setCharacter("S")
