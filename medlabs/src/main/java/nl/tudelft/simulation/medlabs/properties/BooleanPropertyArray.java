...
/**
 * BooleanPropertyArray is a property array for booleans.
 * <p>
 ...
 */
public class BooleanPropertyArray extends PropertyArray<Boolean>
{
    /** the array with the boolean values. */
    private final boolean[] array;
    
    /**
     * Create a new boolean property array.
     * @param name String; the name of the property
     * @param size int; the size of the array
     */
    public BooleanPropertyArray(final String name, final int size)
    {
        super(name, size);
    ...
    {
        return this.array[i] ? (byte) 1 : (byte) 0;
    }
    ...
    {
        return this.array[i] ? (short) 1 : (short) 0;
    }
