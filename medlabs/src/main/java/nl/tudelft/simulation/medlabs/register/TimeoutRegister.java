...
/**
 * The TimeoutDateRegister class contains the last date that a person has been
 * registered, with a timeout on how long the record is kept. An example is a
 * self test that is valid for 2 days. After 2 days, the record is erased
 * automatically.
 * <p>
