...
public class RetailAnimation extends LocationAnimationRect2x1 {
	...
	/** default template. */
	public static final LocationAnimationTemplate RETAIL_TEMPLATE = new LocationAnimationTemplate("Retail")
			.setLineColor(Color.BLUE).setFillColor(null).setCharacter("R").setCharacterColor(Color.BLUE)
			.setCharacterSize(8).setHalfShortSize(4).setNumberColor(Color.BLUE);
