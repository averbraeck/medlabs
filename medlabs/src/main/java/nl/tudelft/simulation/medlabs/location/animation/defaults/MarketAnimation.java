...
public class MarketAnimation extends LocationAnimationRect2x1
{
    ...
    /** default template. */
    public static final LocationAnimationTemplate MARKET_TEMPLATE =
            new LocationAnimationTemplate("Market").setLineColor(Color.BLUE).setFillColor(Color.BLUE).setCharacter("M")
                    .setCharacterColor(Color.BLACK).setCharacterSize(30).setHalfShortSize(15).setNumberColor(Color.BLUE);
