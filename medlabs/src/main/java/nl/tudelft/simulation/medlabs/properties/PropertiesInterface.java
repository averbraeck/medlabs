...
/**
 * PropertiesInterface contains the contract for an object type (Person,
 * Location) to have additional properties. This means that the Person class or
 * the Location class implements the PropertiesInterface. The only return value
 * is float at the moment; this makes calculations easier. When you expect a
 * boolean value; just do <code>value != 0f</code>; when you expect an integer
...
public interface PropertiesInterface {
	/**
	 * Retrieve a floating point value for a named property (can point to an
	 * existing attribute or to a central table).
	 * 
	 * @param name String; the name of the property to retrieve
	 * @return float; the floating point value of the property for the object
	 *         requesting it
	 */
