...
/**
 * The AbstractDurationActivity contains the logic for an Activity that takes a
 * predictable amount of time at a location.
 * <p>
...
public abstract class AbstractDurationActivity extends Activity {
	 ...
	 * @param locator LocatorInterface&lt;T&gt;; the locator that returns where the
	 *                activity takes place
	 */
	public AbstractDurationActivity(final MedlabsModelInterface model, final String name,
			final LocatorInterface locator) {
	...
	public void startActivity(final Person person) {
		...
		this.model.getSimulator()
				.scheduleEvent(new TinySimEvent(this.model.getSimulator().getSimulatorTime() + activityDuration, this,
						this, "finishActivity", new Object[] { person }));
	}
