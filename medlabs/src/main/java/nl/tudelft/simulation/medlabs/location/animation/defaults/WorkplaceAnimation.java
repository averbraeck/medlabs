...
public class WorkplaceAnimation extends LocationAnimationSquare {
	...
	/** default template. */
	public static final LocationAnimationTemplate WORKPLACE_TEMPLATE = new LocationAnimationTemplate("Workplace")
			.setLineColor(Color.BLACK).setFillColor(Color.GRAY).setCharacter("").setHalfShortSize(6)
