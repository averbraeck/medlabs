...
/**
 * ExcelUtil contains base utilities to read and write Excel files. The methods
...
public final class ExcelUtil {
	...
	public static double cellValueDouble(final Row row, final String column) throws Exception {
		...
		try {
			...
			throw new Exception("Error parsing Excel double value " + s + " in cell " + column + row.getRowNum(),
					cause);
		}
	}
