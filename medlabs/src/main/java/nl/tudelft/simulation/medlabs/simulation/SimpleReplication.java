...
/**
 * SimpleReplication is a base implementation of a replication for the MEDLABS
 * simulation.
 * <p>
...
public class SimpleReplication extends SingleReplication<Double> {
	 ...
	 * @param startTime    double; the start time of the new SimpleReplication in
	 *                     hours
	 * @param warmupPeriod double; the warmup period of the new SimpleReplication in
	 *                     hours
	 * @param runLength    double; the run length of the new SimpleReplication in
	 *                     hours
