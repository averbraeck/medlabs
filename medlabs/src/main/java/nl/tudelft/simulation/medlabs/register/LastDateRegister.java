...
/**
 * The LastDateRegister class persistently contains the date that a person has
 * been registered. Only the last date is kept, and it is not an error to
 * register a person multiple times. An example is an official test where the
 * last day of the test is kept.
 * <p>
...
public class LastDateRegister extends AbstractModelNamed implements RegisterInterface {
	 ...
	 * start of the simulation, or -1 if the person has not yet been registered.
	 * 
