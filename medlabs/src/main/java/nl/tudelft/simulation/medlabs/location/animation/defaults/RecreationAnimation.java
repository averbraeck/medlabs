...
/**
 * Animation of a recreation location.
 * <p>
 ...
 */
public class RecreationAnimation extends LocationAnimationSquare
{
    /** */
    private static final long serialVersionUID = 20200919L;

    /** default template. */
    public static final LocationAnimationTemplate RECREATION_TEMPLATE =
            new LocationAnimationTemplate("Recreation").setLineColor(Color.GREEN).setFillColor(null).setCharacter("")
                    .setHalfShortSize(8).setNumberColor(Color.GREEN);

    /**
     * Create the animation for this location object.
     * @param location the location belonging to this animation
     */
    public RecreationAnimation(final Location location)
    {
        super(location, RECREATION_TEMPLATE);
    }
