...
public class RecreationAnimation extends LocationAnimationSquare {
	...
	/** default template. */
	public static final LocationAnimationTemplate RECREATION_TEMPLATE = new LocationAnimationTemplate("Recreation")
			.setLineColor(Color.GREEN).setFillColor(null).setCharacter("").setHalfShortSize(8)
			.setNumberColor(Color.GREEN);
