...
/**
 * Read a number of default parameters from an Excel file and put them in an InputParameterMap.
 * <p>
...
public class ParametersReader
{
     ...
     */
    public static void readParametersXLS(final InputStream fis, final InputParameterMap map) throws InputParameterException
    {
        try
        {
