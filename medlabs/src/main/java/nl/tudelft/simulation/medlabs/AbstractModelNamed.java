...
/**
 * AsbtractModelNamed can be used as a superclass for classes with a name and a
 ...
 */
public abstract class AbstractModelNamed implements ModelNamed {
	/** */
	...
	/**
	 * Create a named, model aware object.
	 * 
	 * @param name  String; the name of the object
	 * @param model MedlabsModelInterface; the reference to the model
	 */
	public AbstractModelNamed(final MedlabsModelInterface model, final String name) {
	...
	public boolean equals(final Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AbstractModelNamed other = (AbstractModelNamed) obj;
		if (this.name == null) {
			if (other.name != null)
				return false;
