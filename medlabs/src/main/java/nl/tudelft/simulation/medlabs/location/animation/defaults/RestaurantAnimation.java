...
public class RestaurantAnimation extends LocationAnimationSquare
{
    ...
    /** default template. */
    public static final LocationAnimationTemplate RESTAURANT_TEMPLATE =
            new LocationAnimationTemplate("Restaurant").setLineColor(Color.ORANGE).setFillColor(Color.WHITE).setCharacter("R")
                    .setCharacterColor(Color.ORANGE).setCharacterSize(12).setHalfShortSize(6).setNumberColor(Color.ORANGE);
