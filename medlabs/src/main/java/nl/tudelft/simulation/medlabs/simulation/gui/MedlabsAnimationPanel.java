...
public class MedlabsAnimationPanel extends AnimationPanel {
	...
	/**
	 * a cache of named classes to consider, mapping the display class to the
	 * vivibility class.
	 */
	 ...
	 * @param simulator  SimulatorInterface&lt;?, ?, ?&gt;; the simulator of which
	 *                   we want to know the events for animation
	 * @throws RemoteException on network error for one of the listeners
	 * @throws DSOLException   when the simulator is not implementing the
	 *                         AnimatorInterface
	 */
	...
	/**
	 * Test whether a certain named class needs to be shown on the screen or not.
	 * The class needs to implement Locatable, otherwise it cannot be shown at all.
	 * Data is stored in two fast-access maps to help
	 * 
	...
	/**
	 * Add a visible element identified by a String (so we can have multiple
	 * show/hide buttons for the same class).
	 * 
	 * @param locatableClass Class&lt;? extends Locatable&gt;; the class for the
	 *                       visibility string
	 * @param displayName    String; the string that identifies the element to be
	 *                       shown
	 */
	...
	/**
	 * Remove a visible element identified by a String (so we can have multiple
	 * show/hide buttons for the same class).
	 * 
	 * @param locatableClass Class&lt;? extends Locatable&gt;; the class for the
	 *                       visibility string
	 ...
	 * @param displayName    String; the string that identifies the element to be
	 *                       shown
	 * @return boolean; whether elements identified by the String are visible at the
	 *         moment.
	 */
	...
	/**
	 * Add an evaluator for a class, which determines if members of the class will
	 * be drawn on the screen or not.
	 * 
	 * @param locatableClass      locatableClass Class&lt;? extends Locatable&gt;;
	 *                            the class for the evaluation
	 * @param visibilityEvaluator VisibilityEvaluator&lt;Locatable&gt;; the
	 *                            evaluator for the class
