...
/**
 * Property is the abstract parent of the typed properties. Properties are descriptors of a stored variable that can be
 * retrieved with a 'get()' method. For Persons, property values are stored in an array, e.g., whether persons have been
 * vaccinated, and the property class serves as a descriptor.
 * <p>
