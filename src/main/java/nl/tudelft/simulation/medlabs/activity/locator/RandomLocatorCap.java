 ...
 */
public class RandomLocatorCap implements LocatorInterface
{
     ...
     */
    public RandomLocatorCap(final LocatorInterface startLocator, final LocationType activityLocationType,
    ...
    public Location getLocation(final Person person)
    {
        ...
        // + "\t" + person.getCurrentActivity() + "\tRL-cap\t" + person.getId());
