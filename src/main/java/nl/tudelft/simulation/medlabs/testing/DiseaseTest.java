...
/**
 * A DiseaseTest is a test that a person can do, with a positive or negative outcome. Because a positive test outcome has very
 * different consequences (e.g., change of week pattern) than a negative test outcome (e.g., admission to a festival), it is
 * important to register the test outcome, rather than just the test itself.
 * <p>
...
public class DiseaseTest extends AbstractModelIdNamed
{
    ...
    /**
     * Create a named, identifiable, model aware test object. TODO: register the positive and negative outcome
