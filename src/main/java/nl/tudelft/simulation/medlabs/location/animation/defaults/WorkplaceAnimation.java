 ...
 */
public class WorkplaceAnimation extends LocationAnimationSquare
{
    /** */
    private static final long serialVersionUID = 20200920L;

    /** default template. */
    public static final LocationAnimationTemplate WORKPLACE_TEMPLATE =
            new LocationAnimationTemplate("Workplace").setLineColor(Color.BLACK).setFillColor(Color.GRAY).setCharacter("")
                    .setHalfShortSize(6).setNumberColor(Color.BLACK);

    /**
     * @param location
     */
    public WorkplaceAnimation(final Location location)
    {
        super(location, WORKPLACE_TEMPLATE);
    }
