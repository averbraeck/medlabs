...
public class MallAnimation extends LocationAnimationRect2x1
{
    ...
    /** default template. */
    public static final LocationAnimationTemplate MALL_TEMPLATE =
            new LocationAnimationTemplate("Mall").setLineColor(Color.BLUE).setFillColor(null).setCharacter("M")
                    .setCharacterColor(Color.BLUE).setCharacterSize(24).setHalfShortSize(12).setNumberColor(Color.BLUE);
