...
public class HospitalAnimation extends LocationAnimationPlus
{
    ...
    /** default template. */
    public static final LocationAnimationTemplate HOSPITAL_TEMPLATE =
            new LocationAnimationTemplate("Hospital").setLineColor(Color.RED).setFillColor(Color.RED).setCharacter("H")
                    .setCharacterColor(Color.BLACK).setCharacterSize(20).setHalfShortSize(10).setNumberColor(Color.RED);
