...
/**
 * Animation of a fire station location.
 * <p>
 ...
 */
public class FireStationAnimation extends LocationAnimationSquare
{
    /** */
    private static final long serialVersionUID = 20200919L;

    /** default template. */
    public static final LocationAnimationTemplate FIRE_TEMPLATE =
            new LocationAnimationTemplate("Police").setHalfShortSize(10).setLineColor(Color.RED).setFillColor(Color.RED)
                    .setCharacter("F").setCharacterColor(Color.BLACK).setNumberColor(Color.RED);

    /**
     * Create the animation for this location object.
     * @param location the location belonging to this animation
     */
    public FireStationAnimation(final Location location)
    {
        super(location, FIRE_TEMPLATE);
    }
