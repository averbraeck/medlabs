...
public class LocationProbBased extends Location
{
    ...
    /** cache for the times when persons present in the location entered this location. */
    private TIntDoubleMap enterTimes = new TIntDoubleHashMap();

    /** the exact phase a person needs to enter into when being exposed in the location based on probability. */
    private final DiseasePhase exposed;

    /**
     * this Person-to-Person map links the group in the location where the probability-based infection takes place to a
    ...
    public void addPerson(final Person person)
    {
        ...
        // NO CALCULATION OF infection spread in this location (BEFORE this person actually enters)
