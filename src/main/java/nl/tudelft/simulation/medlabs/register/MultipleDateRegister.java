...
public class MultipleDateRegister extends AbstractModelNamed implements RegisterInterface
{
    ...
    /**
     * Return the last registration date for this person, measured in days since the start of the simulation, or -1 of the
    ...
    /**
     * Return the registration dates for the person with this id, measured in days since the start of the simulation, or null if
     * the person has not yet been registered.
     * @param personId int; the id of the person to look up
     * @return short[] the registration dates for this person or null if the person is not registered
     */
